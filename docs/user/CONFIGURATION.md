...
This document describes all configuration options and settings available in the My IPX800V3 HA Integration custom integration.
...
```yaml
service: my_ipx800v3.example_service
target:
  ...
  - alias: "Call service at sunset"
    trigger:
      - trigger: sun
        event: sunset
    action:
      - action: my_ipx800v3.example_service
        target:
          entity_id: switch.device_name_switch
        data:
          parameter: "mode"
...
```yaml
blueprint:
  name: My IPX800V3 HA Integration Alert
...
- [GitHub Issues](https://github.com/amg0/ha_ipx800v3/issues) - Report problems
