...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `MyIPX800V3`
...
- Inherit from both platform entity and `MyIPX800V3Entity` (order matters)
...
from custom_components.my_ipx800v3.sensor import async_setup_entry
...
**Config entry data:** `entry_data: MyIPX800V3Data = hass.data[DOMAIN][entry.entry_id]`
