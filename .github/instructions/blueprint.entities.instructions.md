...
- **`entity/`** - Base entity classes (inherit `MyIPX800V3Entity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, MyIPX800V3Entity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import MyIPX800V3Entity`
