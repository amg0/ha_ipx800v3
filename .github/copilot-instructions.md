...
- `entity/` — Base entity class (`MyIPX800V3Entity`)
...
- Entity MRO: `(PlatformEntity, MyIPX800V3Entity)` — order matters
...
- Debug level: `custom_components.my_ipx800v3: debug` in `config/configuration.yaml`
