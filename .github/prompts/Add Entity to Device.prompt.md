...
- Inherit from `MyIPX800V3Entity` and platform base class
...
- Entity: `custom_components/my_ipx800v3/[platform]/[entity_name].py`
- Platform: `custom_components/my_ipx800v3/[platform]/__init__.py`
