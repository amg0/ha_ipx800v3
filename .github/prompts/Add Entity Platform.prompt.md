...
**Directory:** `custom_components/my_ipx800v3/[platform]/`
...
```python
"""[Platform] platform for My IPX800V3 HA Integration."""
...
from .entity import MyIPX800V3Entity
from .[entity_file] import MyIPX800V3[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: MyIPX800V3DataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            MyIPX800V3[EntityName](coordinator, entry),
...
```python
"""[Entity description] for My IPX800V3 HA Integration."""
...
Add platform to `custom_components/my_ipx800v3/manifest.json`:
...
- [ ] Entity class inherits from both `MyIPX800V3Entity` and platform class
...
- **Base entity:** `MyIPX800V3Entity` in `entity/base.py`
- **Coordinator:** `MyIPX800V3DataUpdateCoordinator`
