...
**File:** `custom_components/my_ipx800v3/services.yaml`
...
Create `custom_components/my_ipx800v3/service_actions/[action_name].py`:

```python
"""[Action name] service action for My IPX800V3 HA Integration."""
...
**File:** `custom_components/my_ipx800v3/__init__.py`
...
**File:** `custom_components/my_ipx800v3/const.py`
...
3. Find service action: `my_ipx800v3.[action_name]`
...
- **Domain:** `my_ipx800v3`
- **Service actions directory:** `custom_components/my_ipx800v3/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/my_ipx800v3/services.yaml` (legacy filename)
- **Icons:** `custom_components/my_ipx800v3/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/my_ipx800v3/translations/*.json` under `services` key (legacy)
